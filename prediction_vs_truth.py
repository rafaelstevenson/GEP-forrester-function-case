...
chromosome = ['*', '-', '(X2)', 'a', '(sin)', '(X2)', '?', '*', '*', '/', 'a', '(X2)', '?', 'a', 'a', 'a', '?', '?', 'a', '?', 'a', 'a', '?', '?', '?', 'a', 'a', '4', '1', '2', '9', '10', '1', '4', '11', '5', '0', '1', '1', '11', '11']
term_set = ['a']
const_list = [7.301826832367909, 3.3743838194880063, 7.822176106703315, 8.962410772349745, 9.103833994974288, 13.482257866780673, 7.117137965545833, 3.0682402286266877, 11.659900707947081, 14.454929865923269, 14.931655196972615, 13.085531380958507, 6.329871384493064, 10.320905543793334]
